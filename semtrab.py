...
frame_recomendar.pack(
    anchor="nw", side="left", fill="x", expand="yes", ipady=10, padx=10, pady=10
)
...
frame_lista_libros.pack(anchor="nw", side="left", expand="no", padx=10, pady=10)
...
frame_calificaciones.pack(anchor="nw", side="left", expand="yes", padx=10, pady=10)
